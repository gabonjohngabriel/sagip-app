  ...
  return (
    ...
    sx={{ 
      ...
      <Box sx={{ 
        ...
        etterSpacing={-1} 
        sx={{ mb: 1 }}>
          SAGIP APP<br/>An App for Patients and Doctors.
        </Typography>
        
        <Typography 
        className={`${styles.poppins}`}
        variant="body1" sx={{ mb: 4, color: "#7f7f7f" }}>
        ...
        <Box component="form" onSubmit={handleSubmit}>
          <Box sx={{ mb: 3 }}>
            <Typography 
            className={`${styles.poppins}`}
            variant="caption" sx={{ mb: 0.5, display: "block", color: "text.secondary" }}>
              EMAIL
            </Typography>
            <TextField
              fullWidth
          ...
          <Box sx={{ 
            ...
            <FormControlLabel
              ...
              label={<Typography 
                className={`${styles.poppins}`}
                variant="body2">REMEMBER ME</Typography>}
            />
            <Link 
            to="/forgot-password" style={{ textDecoration: "none" }}>
              <Typography 
