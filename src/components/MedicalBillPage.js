...
const BillPage = () => {
  ...
  return (
    <ThemeProvider theme={theme}>
      <Box className={`${styles.root} ${styles.cardsContainer}`} sx={{ bgcolor: "#f9f9f9", minHeight: "100vh", py: 2 }}>
                ...
                {!isSmallScreen && (
                  <Tabs
                    ...
                    sx={{
                      ...
                      "& .MuiTabs-indicator": { backgroundColor: "rgba(255, 255, 255, 1)" },
                    }}
                  >
                    <Tab 
                            ...
                            .map((bill, index) => (
                              ...
                              >
                                ...
                                <Typography
                                  className={`${styles.poppins}`}                                   
                                  variant="body2"
                                  sx={{ fontSize: "12px", mt: 1, color: "#00000075" }}
                                >
                                  {bill.hospital}
                                </Typography>
                              </Card>
                      ...
                      <CardContent>
                        ...
                        >
                          ...
                          >
                            ...
                            className={` ${styles.poppins} ${styles.bold}`} 
                            sx={{ 
                              letterSpacing: -0.5, color: "#208a3c"                        
                            }}                                                                                                
                            variant="h5">
                              ALL MEDICAL BILLS
                            </Typography>
                            ...
                            {medicalBills.map((bill, index) => (
                              <Card
                                ...
                                sx={{
                                  ...
                                  bgcolor: selectedBill?.id === bill.id ? "#e8f5e9" : "white",
                                }}
                                onClick={() => handleBillSelect(bill)}
                              >
                                <Box
                                ...
                                >
                                  ...
                                  <Chip
                                    ...
                                    label={bill.status}
                                    sx={{
                                      bgcolor: `${getStatusChipColor(bill.status)}15`,
          ...
          >
            ...
            <DialogContent sx={{ mt: 2 }}>
              <Box sx={{ textAlign: "center", mb: 2, mt: 1 }}>
                <Typography 
                className={`${styles.bold} ${styles.poppins}`}    
                variant="h6">Confirm Payment</Typography>
                <Typography 
                className={`${styles.poppins}`}    
                variant="body2" 
                mb={3}
