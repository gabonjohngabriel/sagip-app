...
const AppointmentForm = () => {
  ...
  const handleChange = (e) => {
    ...
    setFormData({
      ...formData,
      [name]: name.includes("is") || name.includes("followUp") || 
              name.includes("consent") || name.includes("privacy") 
              ? checked : value,
    });
  };
  ...
  const doctors = [
    {
      ...
      description: "A Medical Practitioner from Control North, San Jose, San Simon, Pampanga.",
    ...
    },
    {
      ...
      description: "The Best Medical Practitioner who can speak English straight.",
    ...
    <LocalizationProvider dateAdapter={AdapterDateFns}>
      <Fade in={true} timeout={1000}>
        <Box className={`${styles.root} ${styles.green}`}>
          <Container className={`${styles.cardsContainer}`} maxWidth="lg" sx={{ py: 4 }}>
            <Box my={"25px"} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', mb: 4 }}>
              <Logo large />
              <Typography variant="h6" className={`${styles.poppins} ${styles.center}`}>
                SAGIP APP
              </Typography>
              <Typography variant="h4" className={`${styles.poppins} ${styles.center} ${styles.bold}`} sx={{ mt: 2 }}>
                PATIENT APPOINTMENT
              </Typography>
            </Box>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <Typography
                  ...
                  <Box sx={{ p: 3 }}>
                    ...
                    <Typography variant="subtitle1" gutterBottom className={`${styles.poppins} ${styles.bold}`} sx={{ mt: 2 }}>
                    ...
                    >
                      ...
                      >
                        {appointmentTypes.map((type) => (
                          <MenuItem key={type} value={type} className={styles.poppins}>
                            {type}
                          </MenuItem>
                        ))}
                      </Select>
